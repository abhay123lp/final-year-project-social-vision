 ...
 * of this value object you may modify the generated sub-class of this class - ApiFinanceSearchesItem.as.
 */
...
[ExcludeClass]
public class _Super_ApiFinanceSearchesItem extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _ApiFinanceSearchesItemEntityMetadata;
     ...
     * properties
     */
    private var _internal_idyahoosearches : int;
    ...
    private var _internal_call_count : int;
    ...
    public function _Super_ApiFinanceSearchesItem()
    {
        _model = new _ApiFinanceSearchesItemEntityMetadata(this);
    ...
    public function get idyahoosearches() : int
    {
        return _internal_idyahoosearches;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get call_count() : int
    {
    ...
    public function set idyahoosearches(value:int) : void
    {
        var oldValue:int = _internal_idyahoosearches;
        if (oldValue !== value)
        {
            _internal_idyahoosearches = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "idyahoosearches", oldValue, _internal_idyahoosearches));
        }
    }
    ...
    public function set call_count(value:int) : void
    {
        var oldValue:int = _internal_call_count;
        if (oldValue !== value)
        {
            _internal_call_count = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "call_count", oldValue, _internal_call_count));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _ApiFinanceSearchesItemEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _ApiFinanceSearchesItemEntityMetadata) : void
    {
        var oldValue : _ApiFinanceSearchesItemEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
