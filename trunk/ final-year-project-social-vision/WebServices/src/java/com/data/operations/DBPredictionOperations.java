...
public class DBPredictionOperations {
    ...
    public static Vector<FinancialPredictionTask> getAllFinancialPredictionTaskItems()throws SQLException, NamingException{
    ...
    public static Vector<FinancialPredictionPerformanceItem> getPredictionPerformanceItemsForTask(int prediction_task_id)throws SQLException, NamingException{
        DBConnection dbConn = new DBConnection();
    ...
    public static Vector<FinancialPredictionTask> convertRStoFinancialPredictionTaskItems(ResultSet aRs) throws SQLException{
        ...
        while (aRs.next())
        {
            ...
            item.accuracy = aRs.getString("accuracy");
