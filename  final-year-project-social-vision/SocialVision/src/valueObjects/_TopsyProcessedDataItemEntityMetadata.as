...
[ExcludeClass]
internal class _TopsyProcessedDataItemEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("idtopsy_day_data", "_date", "name", "query", "data_group", "histogram_total", "total_results", "no_tweets_collected", "most_used_words", "no_english", "no_not_english", "no_relevant", "no_irrelevant", "no_subjective", "no_objective", "no_neutral", "no_not_neutral", "no_positive_sentiments", "no_negative_sentiments", "no_growth_comments", "no_recession_comments", "no_politically_stable_comments", "no_politically_instable_comments", "no_Intel_comments", "no_Samsung_comments", "no_Imagination_Technologies_comments", "no_Imgtec_comments", "no_ARM_comments", "no_Google_comments", "no_Apple_comments", "no_HTC_comments", "no_Sony_comments", "no_Blackberry_comments", "no_Nokia_comments", "no_Motorola_comments", "no_LG_comments", "no_Microsoft_comments", "no_IBM_comments", "no_ARM_Holdings_comments", "no_RIM_comments");
    model_internal static var allAssociationProperties:Array = new Array();
    model_internal static var allRequiredProperties:Array = new Array();
    model_internal static var allAlwaysAvailableProperties:Array = new Array("idtopsy_day_data", "_date", "name", "query", "data_group", "histogram_total", "total_results", "no_tweets_collected", "most_used_words", "no_english", "no_not_english", "no_relevant", "no_irrelevant", "no_subjective", "no_objective", "no_neutral", "no_not_neutral", "no_positive_sentiments", "no_negative_sentiments", "no_growth_comments", "no_recession_comments", "no_politically_stable_comments", "no_politically_instable_comments", "no_Intel_comments", "no_Samsung_comments", "no_Imagination_Technologies_comments", "no_Imgtec_comments", "no_ARM_comments", "no_Google_comments", "no_Apple_comments", "no_HTC_comments", "no_Sony_comments", "no_Blackberry_comments", "no_Nokia_comments", "no_Motorola_comments", "no_LG_comments", "no_Microsoft_comments", "no_IBM_comments", "no_ARM_Holdings_comments", "no_RIM_comments");
    model_internal static var guardedProperties:Array = new Array();
    model_internal static var dataProperties:Array = new Array("idtopsy_day_data", "_date", "name", "query", "data_group", "histogram_total", "total_results", "no_tweets_collected", "most_used_words", "no_english", "no_not_english", "no_relevant", "no_irrelevant", "no_subjective", "no_objective", "no_neutral", "no_not_neutral", "no_positive_sentiments", "no_negative_sentiments", "no_growth_comments", "no_recession_comments", "no_politically_stable_comments", "no_politically_instable_comments", "no_Intel_comments", "no_Samsung_comments", "no_Imagination_Technologies_comments", "no_Imgtec_comments", "no_ARM_comments", "no_Google_comments", "no_Apple_comments", "no_HTC_comments", "no_Sony_comments", "no_Blackberry_comments", "no_Nokia_comments", "no_Motorola_comments", "no_LG_comments", "no_Microsoft_comments", "no_IBM_comments", "no_ARM_Holdings_comments", "no_RIM_comments");
    model_internal static var sourceProperties:Array = emptyArray
    model_internal static var nonDerivedProperties:Array = new Array("idtopsy_day_data", "_date", "name", "query", "data_group", "histogram_total", "total_results", "no_tweets_collected", "most_used_words", "no_english", "no_not_english", "no_relevant", "no_irrelevant", "no_subjective", "no_objective", "no_neutral", "no_not_neutral", "no_positive_sentiments", "no_negative_sentiments", "no_growth_comments", "no_recession_comments", "no_politically_stable_comments", "no_politically_instable_comments", "no_Intel_comments", "no_Samsung_comments", "no_Imagination_Technologies_comments", "no_Imgtec_comments", "no_ARM_comments", "no_Google_comments", "no_Apple_comments", "no_HTC_comments", "no_Sony_comments", "no_Blackberry_comments", "no_Nokia_comments", "no_Motorola_comments", "no_LG_comments", "no_Microsoft_comments", "no_IBM_comments", "no_ARM_Holdings_comments", "no_RIM_comments");
    model_internal static var derivedProperties:Array = new Array();
    model_internal static var collectionProperties:Array = new Array();
    model_internal static var collectionBaseMap:Object;
    model_internal static var entityName:String = "TopsyProcessedDataItem";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();
    model_internal static var propertyTypeMap:Object;


    model_internal var _instance:_Super_TopsyProcessedDataItem;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _TopsyProcessedDataItemEntityMetadata(value : _Super_TopsyProcessedDataItem)
    {
        ...
        if (model_internal::dependentsOnMap == null)
        {
            ...
            model_internal::dependentsOnMap["idtopsy_day_data"] = new Array();
            ...
            model_internal::dependentsOnMap["histogram_total"] = new Array();
            model_internal::dependentsOnMap["total_results"] = new Array();
        ...
        model_internal::propertyTypeMap["idtopsy_day_data"] = "int";
        ...
        model_internal::propertyTypeMap["histogram_total"] = "int";
        model_internal::propertyTypeMap["total_results"] = "int";
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity TopsyProcessedDataItem");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity TopsyProcessedDataItem");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of TopsyProcessedDataItem");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity TopsyProcessedDataItem");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity TopsyProcessedDataItem");
        }
    ...
    [Bindable(event="propertyChange")]
    public function get isIdtopsy_day_dataAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get isHistogram_totalAvailable():Boolean
    {
        return true;
    }

    [Bindable(event="propertyChange")]
    public function get isTotal_resultsAvailable():Boolean
    {
        return true;
    }
    ...
    [Bindable(event="propertyChange")]   
    public function get idtopsy_day_dataStyle():com.adobe.fiber.styles.Style
    {
    ...
    [Bindable(event="propertyChange")]   
    public function get histogram_totalStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }

    [Bindable(event="propertyChange")]   
    public function get total_resultsStyle():com.adobe.fiber.styles.Style
    {
        return model_internal::_nullStyle;
    }
