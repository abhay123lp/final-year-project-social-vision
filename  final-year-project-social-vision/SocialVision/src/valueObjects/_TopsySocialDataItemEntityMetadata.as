...
[ExcludeClass]
internal class _TopsySocialDataItemEntityMetadata extends com.adobe.fiber.valueobjects.AbstractEntityMetadata
{
    private static var emptyArray:Array = new Array();

    model_internal static var allProperties:Array = new Array("idtopsy_table", "name", "type", "query", "title", "url", "score", "_date", "content", "total_search_results", "trackback_permalink", "hits", "trackback_total", "topsy_trackback_url", "highlight", "is_english", "english_prob", "not_english_prob", "subjectivity", "subjective_prob", "objective_prob", "relevant", "relevant_prob", "irrelevant_prob", "is_neutral", "neutral_prob", "not_neutral_prob", "sentiment", "sentiment_pos_prob", "sentiment_neg_prob", "growth_recession", "growth_prob", "recession_prob", "IntelMention", "SamsungMention", "ImaginationTechMention", "ImgtecMention", "ARMMention", "GoogleMention", "AppleMention", "HTCMention", "SonyMention", "BlackberryMention", "NokiaMention", "MotorolaMention", "LGMention", "MicrosoftMention", "IBMMention", "ARMHoldingsMention", "RIMMention");
    ...
    model_internal static var entityName:String = "TopsySocialDataItem";
    model_internal static var dependentsOnMap:Object;
    model_internal static var dependedOnServices:Array = new Array();
    model_internal static var propertyTypeMap:Object;


    model_internal var _instance:_Super_TopsySocialDataItem;
    model_internal static var _nullStyle:com.adobe.fiber.styles.Style = new com.adobe.fiber.styles.Style();

    public function _TopsySocialDataItemEntityMetadata(value : _Super_TopsySocialDataItem)
    {
    ...
    override public function getDependants(propertyName:String):Array
    {
       if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a data property of entity TopsySocialDataItem");
    ...
    override public function getCollectionBase(propertyName:String):String
    {
        if (model_internal::collectionProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a collection property of entity TopsySocialDataItem");
    ...
    override public function getPropertyType(propertyName:String):String
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
            throw new Error(propertyName + " is not a property of TopsySocialDataItem");
    ...
    override public function getValue(propertyName:String):*
    {
        if (model_internal::allProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " does not exist for entity TopsySocialDataItem");
        }
    ...
    override public function setValue(propertyName:String, value:*):void
    {
        if (model_internal::nonDerivedProperties.indexOf(propertyName) == -1)
        {
            throw new Error(propertyName + " is not a modifiable property of entity TopsySocialDataItem");
        }
