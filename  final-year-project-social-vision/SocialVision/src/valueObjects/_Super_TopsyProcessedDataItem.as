 ...
 * of this value object you may modify the generated sub-class of this class - TopsyProcessedDataItem.as.
 */
...
[ExcludeClass]
public class _Super_TopsyProcessedDataItem extends flash.events.EventDispatcher implements com.adobe.fiber.valueobjects.IValueObject
{
    ...
    model_internal var _dminternal_model : _TopsyProcessedDataItemEntityMetadata;
     ...
     * properties
     */
    private var _internal_idtopsy_day_data : int;
    private var _internal__date : Date;
    private var _internal_name : String;
    private var _internal_query : String;
    private var _internal_data_group : String;
    private var _internal_histogram_total : int;
    private var _internal_total_results : int;
    ...
    public function _Super_TopsyProcessedDataItem()
    {
        _model = new _TopsyProcessedDataItemEntityMetadata(this);
    ...
    public function get idtopsy_day_data() : int
    {
        return _internal_idtopsy_day_data;
    }
    ...
    [Bindable(event="propertyChange")]
    public function get histogram_total() : int
    {
        return _internal_histogram_total;
    }

    [Bindable(event="propertyChange")]
    public function get total_results() : int
    {
    ...
    public function set idtopsy_day_data(value:int) : void
    {
        var oldValue:int = _internal_idtopsy_day_data;
        if (oldValue !== value)
        {
            _internal_idtopsy_day_data = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "idtopsy_day_data", oldValue, _internal_idtopsy_day_data));
        }
    }
    ...
    public function set histogram_total(value:int) : void
    {
        var oldValue:int = _internal_histogram_total;
        if (oldValue !== value)
        {
            _internal_histogram_total = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "histogram_total", oldValue, _internal_histogram_total));
        }
    }

    public function set total_results(value:int) : void
    {
        var oldValue:int = _internal_total_results;
        if (oldValue !== value)
        {
            _internal_total_results = value;
            this.dispatchEvent(mx.events.PropertyChangeEvent.createUpdateEvent(this, "total_results", oldValue, _internal_total_results));
        }
    }
    ...
    [Transient]
    [Bindable(event="propertyChange")]
    public function get _model() : _TopsyProcessedDataItemEntityMetadata
    {
        return model_internal::_dminternal_model;
    }

    public function set _model(value : _TopsyProcessedDataItemEntityMetadata) : void
    {
        var oldValue : _TopsyProcessedDataItemEntityMetadata = model_internal::_dminternal_model;
        if (oldValue !== value)
        {
